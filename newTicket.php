...
<head><title>New Staff Ticket</title></head>
<body>
  ...
  <div>
    <div class="col-sm-9"><h1>New Staff Ticket</h1></div>
    <?php
    $timestamp - time();
    ...
    <div class=col-sm-7>
            ...
            <div class=col><input readonly class= form-control type= text name= addusergroup value=STAFF></div>
            </div>
            </div>
            ...
            <div class=col><input class= form-control type= text name= addPriority value=></div>
            </div>
            </div>
